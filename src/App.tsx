...
import ResultsPage from './frontend/pages/ResultsPage/ResultsPage';
import ProfilePage from './frontend/pages/ProfilePage/ProfilePage';
import JudgePage from './frontend/pages/JudgePage/JudgePage';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/judge"             element={<ProtectedRoute><JudgePage /></ProtectedRoute>} />
